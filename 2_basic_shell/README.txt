...
# - add a %runscript to print out a message using cowsay when the container is run
# - add the location of the cowsay executable (/usr/games/) to the PATH environment variable via the %environment
# - set an environment variable for the locale via the %environment
